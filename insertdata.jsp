...
<%
					...
					try {
						...
						PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,pincode,status,image,binaryimage) values(?,?,?,?,?,?,?,?,?,?,?)");
